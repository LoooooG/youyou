...
import com.hotniao.live.activity.HnPlayBackPayActivity;
...
import com.hotniao.live.adapter.HnPlaybackAdapter;
...
public class HnPlayBackListFragment extends BaseScollFragment implements BaseRequestStateListener {
    ...
    public void requestSuccess(String type, String response, Object obj) {
        ...
        if (HnHomeBiz.Banner.equals(type)) {
            ...
            com.hotniao.live.utils.HnUiUtils.setRefreshMode(mRefresh, mPage, 10, mData.size());
