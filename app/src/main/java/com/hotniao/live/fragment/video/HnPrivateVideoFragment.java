 ...
 * Version:  1.0.0
 */
public class HnPrivateVideoFragment extends BaseScollFragment implements HnLoadingLayout.OnReloadListener, BaseRequestStateListener {
    public static final String TAG = "HnPrivateVideoFragment";
    ...
    public static HnPrivateVideoFragment getInstance() {
        HnPrivateVideoFragment fragment = new HnPrivateVideoFragment();
        return fragment;
    }
    ...
    private void getData() {
            mHnHomeBiz.getOneHomeHotVideo(mPage, 0, null, null, null, null, null,"2");
    }
