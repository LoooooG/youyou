...
import com.hotniao.video.adapter.HnBillVideoChatEarnAdapter;
import com.hotniao.video.adapter.HnBillVideoShowEarnAdapter;
import com.hotniao.video.dialog.HnEarningTotalTypePopWindow;
import com.hotniao.video.model.HnBillInviteDetailModel;
import com.hotniao.video.model.HnLiveBackEarnModel;
 ...
 * Version:  1.0.0
 */
public class HnBillVideoShowEarnFragment extends BaseFragment {
    ...
    private int mPage = 1;
    private HnBillVideoShowEarnAdapter mAdapter;
    ...
    public static HnBillVideoShowEarnFragment newInstance(int index) {
        HnBillVideoShowEarnFragment dialog = new HnBillVideoShowEarnFragment();
    ...
    public void initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //初始化适配器
        mAdapter = new HnBillVideoShowEarnAdapter(mData);
    ...
    protected void initData() {
        ...
        HnHttpUtils.getRequest(HnUrl.VIDEO_CONSUME_DOT, param, TAG, new HnResponseHandler<HnLiveBackEarnModel>(mActivity, HnLiveBackEarnModel.class) {
            ...
            public void hnSuccess(String response) {
                try {
                    ...
                    if (model.getC() == 0) {
                        List<HnLiveBackEarnModel.DBean.ItemsBean> items = model.getD().getItems();
