...
import com.hotniao.video.adapter.HnBillLiveBackEarnAdapter;
...
public class HnBillLiveBackEarnFragment extends BaseFragment {
    ...
    private int mPage = 1;
    private HnBillLiveBackEarnAdapter mAdapter;
    ...
    public static HnBillLiveBackEarnFragment newInstance(int index) {
        HnBillLiveBackEarnFragment dialog = new HnBillLiveBackEarnFragment();
    ...
    public void initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //初始化适配器
        mAdapter = new HnBillLiveBackEarnAdapter(mData);
    ...
    protected void initData() {
        ...
        HnHttpUtils.getRequest(HnUrl.PLAY_BACK_CONSUME_DOT, param, "PLAY_BACK_CONSUME_DOT", new HnResponseHandler<HnLiveBackEarnModel>(mActivity, HnLiveBackEarnModel.class) {
