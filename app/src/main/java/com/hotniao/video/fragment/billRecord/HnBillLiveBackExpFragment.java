...
import com.hotniao.video.base.CommListFragment;
import com.hotniao.video.model.HnBuyVipRecordModel;
...
public class HnBillLiveBackExpFragment extends CommListFragment {
    ...
    public static HnBillLiveBackExpFragment newInstance() {
        HnBillLiveBackExpFragment fragment = new HnBillLiveBackExpFragment();
        return fragment;
    }
    ...
    protected CommRecyclerAdapter setAdapter() {
        ...
        mAdapter = new CommRecyclerAdapter() {
            ...
            protected void onBindView(BaseViewHolder holder, int position) {
                //时间
                ((TextView)holder.getView(R.id.mTvContent)).setText("观看"+mData.get(position).getUser_nickname()+HnUiUtils.getString(R.string.live_play_back));
