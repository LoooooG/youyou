...
public class HnBillVideoShowExpFragment extends CommListFragment {
    ...
    public static HnBillVideoShowExpFragment newInstance() {
        HnBillVideoShowExpFragment fragment = new HnBillVideoShowExpFragment();
        return fragment;
    }
    ...
    protected CommRecyclerAdapter setAdapter() {
        ...
        mAdapter = new CommRecyclerAdapter() {
            ...
            protected void onBindView(BaseViewHolder holder, int position) {
                //时间
                ((TextView)holder.getView(R.id.mTvContent)).setText("观看"+mData.get(position).  getUser_nickname()+ HnUiUtils.getString(R.string.video_show));
