...
public class HnBillVideoChatEarnFragment extends BaseFragment {
    ...
    public static HnBillVideoChatEarnFragment newInstance(int index) {
        HnBillVideoChatEarnFragment dialog = new HnBillVideoChatEarnFragment();
    ...
    public void initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //初始化适配器
        mAdapter = new HnBillVideoChatEarnAdapter(mData);
    ...
    protected void initData() {
        ...
        HnHttpUtils.getRequest(HnUrl.CHAT_CONSUME_DOT, param, TAG, new HnResponseHandler<HnLiveBackEarnModel>(mActivity, HnLiveBackEarnModel.class) {
