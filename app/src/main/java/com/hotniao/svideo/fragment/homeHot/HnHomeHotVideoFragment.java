package com.hotniao.svideo.fragment.homeHot;
 ...
 * Version:  1.0.0
 */
public class HnHomeHotVideoFragment extends BaseScollFragment implements HnLoadingLayout.OnReloadListener, BaseRequestStateListener {
    ...
    public static HnHomeHotVideoFragment getInstance() {
        HnHomeHotVideoFragment fragment = new HnHomeHotVideoFragment();
        return fragment;
    }
...
//        mLoading.setBackgroundResource(background.resourceId);
    ...
    private void getData() {
        if (HnMainActivity.mLocEntity == null)
            mHnHomeBiz.getOneHomeHotVideo(mPage, 1, null, null, null, null, null,null);
        else
            mHnHomeBiz.getOneHomeHotVideo(mPage, 1, HnMainActivity.mLocEntity.getmLng(), HnMainActivity.mLocEntity.getmLat(), null, null, null,null);
    }
