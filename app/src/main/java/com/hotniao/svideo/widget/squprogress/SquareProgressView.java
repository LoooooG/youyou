package com.hotniao.svideo.widget.squprogress;
...
public class SquareProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isIndeterminate()) {
            ...
            if (drawEnd.place == Place.TOP) {
                if (drawEnd.location < (canvas.getWidth()) && progress < 100.0) {
    ...
    public DrawStop getDrawEnd(float percent, Canvas canvas) {
        ...
        strokewidth = CalculationUtil.convertDpToPx(widthInDp, getContext());
        float halfOfTheImage = canvas.getWidth();
