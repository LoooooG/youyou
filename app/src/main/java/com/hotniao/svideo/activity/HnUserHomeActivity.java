...
import com.hotniao.svideo.dialog.HnDelBlackReportDialog;
import com.hotniao.svideo.dialog.HnReportUserDialog;
import com.hotniao.svideo.dialog.HnShareDialog;
import com.hotniao.svideo.fragment.userhome.HnUserHomeBackFragment;
import com.hotniao.svideo.fragment.userhome.HnUserHomeInfoFragment;
import com.hotniao.svideo.fragment.userhome.HnUserHomeVideoFragment;
...
public class HnUserHomeActivity extends BaseActivity implements BaseRequestStateListener {
    ...
    private static String[] mTitles = {HnUiUtils.getString(R.string.user_info),HnUiUtils.getString(R.string.user_play_back), HnUiUtils.getString(R.string.video_show)};
    ...
    public static void luncher(Activity activity, String uid) {
        activity.startActivity(new Intent(activity, HnUserHomeActivity.class).putExtra("uid", uid));
    }
    ...
    public void onCreateNew(Bundle savedInstanceState) {
        ...
        mDetailBiz = new HnUserDetailBiz(this);
    ...
    private void initAdapter() {
        LinearLayoutManager mPhotoManager = new LinearLayoutManager(this);
...
//        mRecyclerClosed.addItemDecoration(new HnSpacesItemDecoration(6, false));
        ...
        mPhotoAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                HnUserClosedRankActivity.luncher(HnUserHomeActivity.this, mUid, mUserInfo.getUser_nickname());
            }
        });
...
@OnClick({R.id.mIvBack, R.id.mIvMore, R.id.mIvShare, R.id.mRlClosedFriends, R.id.mLlFocus, R.id.mLlChat, R.id.mLlChatVideo})
        ...
        switch (view.getId()) {
            ...
            case R.id.mIvShare:
                ...
                HnShareDialog.newInstance(mShareAPI, mShareAction, mUserInfo.getUser_nickname() + getString(R.string.join_this_app_invite_you), HnUrl.setImageUrl(mUserInfo.getUser_avatar()),
                        mUserInfo.getShare_url(), mUserInfo.getUser_nickname() + getString(R.string.join_this_app)).show(getFragmentManager(), "share");
            ...
            case R.id.mLlChat:
                ...
                startActivity(new Intent(HnUserHomeActivity.this, HnPrivateChatActivity.class).putExtras(bundle));
                break;
            case R.id.mLlChatVideo:
                if (mUserInfo == null) return;
                if (HnApplication.getmUserBean().getUser_id().equals(mUserInfo.getUser_id()))
                    return;
                HnInviteChatBeforeActivity.luncher(HnUserHomeActivity.this, mUserInfo.getUser_id(), mUserInfo.getUser_avatar(), mUserInfo.getIs_online());
                break;
    ...
    private void initViews(boolean isAnchor){
        ...
        if(adapter == null){
            adapter = new HnScrollViewPagerAdapter(getSupportFragmentManager(), mFragments, mTitles);
