...
public class GiftModel {
    ...
    public static GiftModel create(String giftId, String giftName, int giftCont, String giftPic, String sendUserId,
        ...
        giftModel.setSnedUserLv(snedUserLv);
        return giftModel;
    }
    ...
    public String getSnedUserLv() {
        return snedUserLv;
    }

    public void setSnedUserLv(String snedUserLv) {
        this.snedUserLv = snedUserLv;
    }
}
