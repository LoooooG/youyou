...
public class VideoMaterialDownloadProgress {
    public static final String DOWNLOAD_FILE_POSTFIX = ".mp3";
    public static final String ONLINE_MATERIAL_FOLDER = "music";
    ...
    public void start(Downloadlistener listener) {
        ...
        HttpFileListener fileListener = new HttpFileListener() {
            @Override
            public void onSaveSuccess(File path) {
...
//                }
//                file.delete();
                mListener.onDownloadSuccess(path.getPath());
                stop();
            }
