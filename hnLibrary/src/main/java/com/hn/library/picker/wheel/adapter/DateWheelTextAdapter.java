 ...
 */
package com.hn.library.picker.wheel.adapter;
 ...
 */
public abstract class DateWheelTextAdapter extends AbstractWheelAdapter {
	 ...
	 *            the current context
	 */
	protected DateWheelTextAdapter(Context context) {
	 ...
	 */
	protected DateWheelTextAdapter(Context context, int itemResource) {
	 ...
	 */
	protected DateWheelTextAdapter(Context context, int itemResource, int itemTextResource, int currentIndex,
								   int maxsize, int minsize) {
		this.context = context;
		itemResourceId = itemResource;
		itemTextResourceId = itemTextResource;
		this.currentIndex = currentIndex;
		DateWheelTextAdapter.maxsize = maxsize;
		DateWheelTextAdapter.minsize = minsize;
