 ...
 */
public abstract class AddressWheelTextAdapter extends AbstractWheelAdapter {
	 ...
	 *            the current context
	 */
	protected AddressWheelTextAdapter(Context context) {
	 ...
	 */
	protected AddressWheelTextAdapter(Context context, int itemResource) {
	 ...
	 */
	protected AddressWheelTextAdapter(Context context, int itemResource, int itemTextResource, int currentIndex,
