package com.hn.library.refresh.indicator;
...
public class PtrIndicator { 
    ...
    private float mRatioOfHeaderHeightToRefresh = 0.6f;
    private float mResistanceHeader = 2.0f;
    private float mResistanceFooter = 2.0f;
