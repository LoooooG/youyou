...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private boolean isSetDrawableRight;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mUnTextsize = ta.getDimension(R.styleable.SlidingTabLayout_tl_untextsize, 0);
        if (0 == mUnTextsize) mUnTextsize = mTextsize;
        ...
        isSetDrawableRight = ta.getBoolean(R.styleable.SlidingTabLayout_tl_textDrawableRightSet, false);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ? mTextsize : mUnTextsize);
                ...
                if (mTextBold == TEXT_BOLD_BOTH) {
                    tv_tab_title.getPaint().setFakeBoldText(i == mCurrentTab ? true : false);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            setDrawableRight(tab_title);
            if (tab_title != null) {
                tab_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
                tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, isSelect ? mTextsize : mUnTextsize);
...
//                }
    ...
    private void setDrawableRight(TextView tv) {
//        if (isSetDrawableRight) {
