...
public class HnBannerLayout extends RelativeLayout {
    ...
    private Position indicatorPosition = Position.rightBottom;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        int position = array.getInt(R.styleable.BannerLayoutStyle_indicatorPosition, Position.rightBottom.ordinal());
