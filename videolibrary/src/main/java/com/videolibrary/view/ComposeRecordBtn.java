...
public class ComposeRecordBtn extends RelativeLayout {
    ...
    public void startRecord(){
        ...
        ObjectAnimator recordStartZoomOutXAn = ObjectAnimator.ofFloat(mIvRecordStart, "scaleX", 1.25f);
        ObjectAnimator recordStartZoomOutYAn = ObjectAnimator.ofFloat(mIvRecordStart, "scaleY", 1.25f);
