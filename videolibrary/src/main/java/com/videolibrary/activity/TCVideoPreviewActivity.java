        ...
        if (v.getId() == R.id.record_delete) {
            ...
            if (mVideoPlay) {
                if (mVideoPause) {
                    ...
                    mStartPreview.setBackgroundResource(R.drawable.record_pause);
                    mVideoPause = false;
                } else {
                    mTXLivePlayer.pause();
                    mStartPreview.setBackgroundResource(R.drawable.record_start);
                    mVideoPause = true;
                }
            } else {
                startPlay();
            }
        } else if (v.getId() == R.id.video_publish) {
            publish();
        } else if (v.getId() == R.id.record_to_edit) {
            startEditVideo();
        }
